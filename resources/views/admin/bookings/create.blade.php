            ...
            <form action="{{ route('admin.bookings.store') }}" method="POST" class="space-y-6" id="booking-form">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <div>
                        ...
                        <select name="boarding_house_id" id="boarding_house_id" required
                                class="block w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-livora-primary focus:border-[#ff6900] @error('boarding_house_id') border-red-500 @enderror">
                    ...
                    <div>
                        ...
                        <select name="room_id" id="room_id" required
                                class="block w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-livora-primary focus:border-[#ff6900] @error('room_id') border-red-500 @enderror">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="date" name="start_date" id="start_date" value="{{ old('start_date') }}" required
                               min="{{ date('Y-m-d') }}"
                               class="block w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-livora-primary focus:border-[#ff6900] @error('start_date') border-red-500 @enderror">
                        @error('start_date')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="date" name="end_date" id="end_date" value="{{ old('end_date') }}" required
                               class="block w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-livora-primary focus:border-[#ff6900] @error('end_date') border-red-500 @enderror">
                        @error('end_date')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    <div>
                        ...
                        <input type="number" name="base_amount" id="base_amount" value="{{ old('base_amount') }}" required min="0" step="1000"
                               class="block w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-livora-primary focus:border-[#ff6900] @error('base_amount') border-red-500 @enderror">
                        @error('base_amount')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" name="additional_fees" id="additional_fees" value="{{ old('additional_fees', 0) }}" min="0" step="1000"
                               class="block w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-livora-primary focus:border-[#ff6900] @error('additional_fees') border-red-500 @enderror">
                    ...
                    <div>
                        ...
                        <input type="number" name="final_amount" id="final_amount" value="{{ old('final_amount') }}" required min="0" step="1000" readonly
                               class="block w-full px-3 py-2 border border-gray-300 rounded-lg bg-gray-100 focus:ring-livora-primary focus:border-[#ff6900] @error('final_amount') border-red-500 @enderror">
                        @error('final_amount')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div>
                    ...
                    <textarea name="special_requests" id="special_requests" rows="3"
                              class="block w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-livora-primary focus:border-[#ff6900] @error('special_requests') border-red-500 @enderror">{{ old('special_requests') }}</textarea>
