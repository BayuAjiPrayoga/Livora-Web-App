    ...
    <div class="p-4">
        ...
        @if($property->rooms->count() > 0)
            <div class="space-y-3">
                ...
                @foreach($property->rooms->take(3) as $room)
                    ...
                    @endphp
                    <div class="border border-gray-200 rounded-lg p-3 {{ $isAvailable ? 'hover:border-livora-primary' : 'opacity-75' }} transition-colors relative">
                        <div class="flex justify-between items-start mb-2">
                            ...
                            <div class="text-right">
                                <p class="text-lg font-bold text-livora-primary">
                ...
                @if($property->rooms->count() > 3)
                    <div class="text-center">
                        <button type="button" class="text-livora-primary text-sm font-medium hover:underline">
        ...
        @if($property->phone)
            <div class="mt-4 pt-4 border-t border-gray-100">
                <a href="tel:{{ $property->phone }}" class="flex items-center text-sm text-gray-600 hover:text-livora-primary">
