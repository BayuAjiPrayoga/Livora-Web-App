...
<div class="bg-livora-background">
    ...
    <div class="bg-white shadow-sm border-b">
        <div class="px-6 py-4">
            <h1 class="text-2xl font-bold text-livora-text">Dashboard Mitra</h1>
            <p class="text-gray-600 mt-1">Selamat datang di LIVORA - Live Better, Stay Better</p>
        </div>
    </div>
    ...
    <div class="p-6 space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <!-- Total Revenue Card -->
            <div class="bg-white rounded-lg shadow-md p-6 border-l-4 border-livora-primary">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-sm font-medium text-gray-600">Total Pendapatan</p>
                        <p class="text-2xl font-bold text-livora-text">Rp {{ number_format($totalRevenue, 0, ',', '.') }}</p>
                        <p class="text-xs text-gray-500 mt-2">Keseluruhan waktu</p>
                    </div>
                    <div class="p-3 bg-livora-primary bg-opacity-10 rounded-full">
            ...
            <div class="bg-white rounded-lg shadow-md p-6 border-l-4 border-green-500">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-livora-text">{{ $totalRooms > 0 ? number_format(($occupiedRooms / $totalRooms) * 100, 1) : 0 }}%</p>
                        <p class="text-xs text-gray-500 mt-2">{{ $occupiedRooms }} dari {{ $totalRooms }} kamar</p>
                    </div>
            ...
            <div class="bg-white rounded-lg shadow-md p-6 border-l-4 border-orange-500">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-livora-text">{{ $pendingTickets }}</p>
                        <p class="text-xs text-gray-500 mt-2">Perlu ditangani</p>
                    </div>
        ...
        <div class="bg-white rounded-lg shadow-md">
            <div class="px-6 py-4 border-b border-gray-200">
                <h2 class="text-lg font-semibold text-livora-text">Booking Terbaru</h2>
                <p class="text-sm text-gray-600 mt-1">10 booking terbaru dari properti Anda</p>
            </div>
            
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-livora-background">
                        <tr>
